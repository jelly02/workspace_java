...
//		System.out.println(Utility.getCurrentDate()); // another class 호출
//		System.out.println(Utility.getCurrentDate("yyyy/MM/dd")); 
//		System.out.println(Utility.getCurrentDate("yyyy/MM/dd hh:ss")); 
...
//		System.out.println(Utility.getCurrentDate("yyyy/MM/dd [a] hh:ss", Locale.JAPAN));
//	}
}
