...
public class RandomTeamTest_teacher {
	
	/*
	 * 수행결과 : 일부 학생의 이름이 중복 됨
	 * 
	 * 개선사항 : 팀원 이름 정렬 (String#compareTo(String)
	 * 
	 * 
	 * */
	...
	public static void main(String[] args) {
		...
		if (args.length == 1) {
			...
			//default
			System.out.println("[사용방법] java RandomTeamTest_teacher 팀별인원숫자");
